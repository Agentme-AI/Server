...
const SKILL_SOURCE_GROUPS: Array<{ id: string; label: string; sources: string[] }> = [
  { id: "workspace", label: "Workspace Skills", sources: ["agentme-workspace"] },
  { id: "built-in", label: "Built-in Skills", sources: ["agentme-bundled"] },
  { id: "installed", label: "Installed Skills", sources: ["agentme-managed"] },
  { id: "extra", label: "Extra Skills", sources: ["agentme-extra"] },
];
